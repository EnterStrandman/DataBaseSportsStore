	...
	<div class="container">
		<div class="col-2">
			<div class="sidenav">
				...
				<form method="post">
					...
					<p style="margin-top: 80px;">Please type the name of the person and street name to be added to the database(DO NOT INCLUDE HOUSE NUMBER, CITY, STATE OR ZIP CODE)</p>
					<p style="margin-bottom: 0px;">Name</p>
					<input style="color:black" type="text" name="name">
					<p style="margin-bottom: 0px; margin-top: 3px;">Street Name</p>
					<input style="color:black" type="text" name="address">
		...
		<?php 
			if (isset($_POST["name"]) && isset($_POST["address"])){
				...
				$sql = "INSERT INTO `customers` (`ID`, `NAME`, `ADDRESS`) VALUES (NULL, '$name', '$address');";
				...
				if ($conn->query($sql) === TRUE) {
					...
					$sql_result = "SELECT * FROM `customers` WHERE NAME='$name' ORDER BY ID DESC LIMIT 1;";
