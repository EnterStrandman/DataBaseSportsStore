...
<body>
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-right" style="padding-top: 20px; padding-right: 4px;">
		      <li><a style="" href="index.php">Home</a></li>
	...
	<?php 
		...
		echo"<tr>
				...
				<td align='left' style='padding-left: 5px; padding-top:10px;'><b>NAME</b></td>
				<td align='left' style='padding-left: 0px; padding-top:10px;'><b>COMMISSION RATE</b></td>
			 </tr>";

		while($row = mysqli_fetch_assoc($result)){
			echo"<tr><td style='padding-left: 30px; padding-right:20px; padding-bottom:5px; align='center'>{$row['ID']}</td><td>{$row['NAME']}</td><td>{$row['COMMISSION_RATE']}</td></tr>";
		}
